...
from llm_agent.runtime.transport import (
    Channel,
    Message,
    QueueChannel,
    Request,
...
class TestQueueChannel:
    ...
    def test_send_recv_roundtrip(self):
        ...
        main_ch, sub_ch = create_channel_pair()
    ...
    def test_close_prevents_recv(self):
...
class TestChannelProtocol:
    ...
    def test_queue_channel_implements_protocol(self):
        """QueueChannel implements Channel protocol."""
        main_ch, _ = create_channel_pair()
