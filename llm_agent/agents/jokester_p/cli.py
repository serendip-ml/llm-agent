...
class JokesterCLI(Tool):
    ...
    def _finalize_training(self, result: Any, opts: dict[str, Any]) -> int:
        ...
        self._print_train_summary(
            len(result.pairs), opts["adapter_name"], opts["margin"], opts["dry_run"]
        )
        ...
        self._execute_training_run(client, result.pairs, opts["adapter_name"])
        return 0
    ...
    def _execute_training_run(
        self, client: LearnClient, pairs: list[Any], adapter_name: str
    ) -> None:
