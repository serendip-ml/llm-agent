...
from llm_agent.llm.types import CompletionResult
from llm_agent.traits.llm import LLMConfig
...
class LearnTrait:
    ...
    Example:
        from llm_agent.traits import LearnTrait, LearnConfig, LLMConfig
